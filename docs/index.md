...
QuestMaster is a platform for managing tabletop RPG games (e.g. D&D 5e), built for [Club JDR](https://club-jdr.fr).
...
- [Architecture](architecture/models.md) — understand the data model, repositories, services, and exception hierarchy.
- [Contributing](contributing.md) — guidelines for contributing to the project.
- [GitHub Repository](https://github.com/Club-JDR/questmaster)
