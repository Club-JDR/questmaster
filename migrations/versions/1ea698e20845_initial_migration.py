...
def upgrade():
    ...
    sa.Column('type', postgresql.ENUM('oneshot', 'campaign', name='game_type_enum'), nullable=False),
    ...
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('type', sa.Enum('oneshot', 'campaign', name='game_type_enum'), nullable=False),
