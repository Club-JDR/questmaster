...
function showPostMessage(redirectUrl) {
  const outro = introJs();
  ...
  outro.setOptions({
    steps: [
      {
      element: '#postNewGame',
      intro: "Voyons maintenant comment poster une annonce. Tout d'abord, cliquons sur ce bouton." +
