...
def build_annonce_details_embed(game, **_) -> tuple[dict, str]:
    ...
    embed = {
        ...
        "description": (
            ...
            f"- N'hésite pas à programmer tes sessions **à l'avance** directement depuis ce salon avec `/ajouter-session`, "
            f"par exemple : `/ajouter-session debut:10/09/2026 20:00`.\n"
