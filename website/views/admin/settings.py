...
# Local imports
from config.constants import DISCORD_ROLE_LIMIT
...
def update_permissions_settings():
    """Update the direct-permission mode toggle and its auto-enable threshold."""
    ...
    try:
        ...
        flash("Paramètres de permissions mis à jour.", "success")
    except ValidationError as e:
        flash(str(e), "danger")
    return redirect(url_for("admin.edit_settings"))
