...
fake_games = [
    {
            ...
            "party_selection": "on",
            "ambience":["chill", "epic"],
            "classification":{"action": 2, "investigation": 1, "interaction": 2, "horror": 1},
            "img": "https://r2.foundryvtt.com/website-uploads-public/screen/user_70/toa-banner-2025-05-13.webp",
            "date": session_start,
            "session_length": "3.5",
            "players": [{"name": "Riri", "avatar": "https://picsum.photos/id/237/200/300"}, {"name": "Fifi", "avatar": "https://picsum.photos/id/96/367/267"}],
            "sessions": [
                {'start': session_start, "end": session_start+ timedelta(hours=3)},
                {'start': session_start+ timedelta(weeks=1), "end": session_start+timedelta(weeks=1, hours=3)}
              ]
        },
        {
...
def demo_register():
    return render_template("game_details.j2", game=fake_games[0], is_player=False, payload={"user_id": '123', 'is_admin': False})